...
public class ProdutoOUT {
    ...
    public ProdutoOUT(String idProduto, String quantidadeProduto) {
        this.idProduto = idProduto;
        this.quantidadeProduto = quantidadeProduto;
    }

    public ProdutoOUT(String idProduto, String quantidadeProduto, String nome, Double preco, String categoria,
                      String uriImagem) {
        this.idProduto = idProduto;
        this.quantidadeProduto = quantidadeProduto;
        this.nome = nome;
